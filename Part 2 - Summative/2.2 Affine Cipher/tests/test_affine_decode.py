...
class Test(TestCase):
    def test_affine_decode_even_lowercase(self):
    ...
    def test_affine_decode_even_uppercase(self):
        self.assertEqual(affine_decode("OEV FRHPN MIZXW YZA KRTCL ZUVI OEV QJGD SZB.", 3, 9), "THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG.")
    def test_affine_decode_even_upper_lowercase(self):
        self.assertEqual(affine_decode("Oev frhpn mizxw yza krtcl zuvi oev qjgd szb.", 3, 9), "THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG.")
    def test_affine_decode_even_lowercase(self):
        self.assertEqual(affine_decode("oev frhpn mizxw yza krtcl zuvi oev qjgd szb.", 3, 9), "THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG.")
    def test_affine_decode_odd_same_number(self):
    ...
    def test_affine_decode_odd_one_letter(self):
        self.assertEqual(affine_decode("P", 5, 15), "A")
    def test_affine_decode_one_word_empty(self):
        self.assertEqual(affine_decode("", 5, 15), "")
    def test_affine_decode_one_word_odd_one(self):
